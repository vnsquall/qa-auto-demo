...
public class GeolocationPage {
    ...
    public static void geoPageLoaded(){
        Helpers.find_element(geoLink).click();
        Assert.assertEquals(Helpers.find_element(geoText).getText(), "Geolocation", "Text Not Found");
        Assert.assertEquals(Helpers.find_element(demoText).getText(), "Click the button to get your current latitude and longitude",
                "Text Not Found");
    }

    public static void click_whereBtn(){
        Helpers.find_element(whereBtn).click();
    }
}
